 ...
 * or sbbuild/licenses/CDDL-GPL-2-CP. See the License for the
 * specific language governing permissions and limitations under the
 * License.  When distributing the software, include this License Header
 * Notice in each file and include the License file at
 * sbbuild/licenses/CDDL-GPL-2-CP.  Sun designates this
...
public final class Favorites {
    ...
    public synchronized boolean selectWithAddition(FileObject fo) throws DataObjectNotFoundException {
        ...
        FavoritesActions.Add.selectAfterAddition(obj);
        return result;
    }
    ...
    private DataShadow[] addInternal(FileObject... toAdd) throws DataObjectNotFoundException {
        ...
        FavoritesActions.Add.reorderAfterAddition(f, f.getChildren(), Arrays.asList(createdDOs));
        return createdDOs;
    }
