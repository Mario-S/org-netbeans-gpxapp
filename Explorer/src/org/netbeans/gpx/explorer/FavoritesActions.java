...
public final class FavoritesActions {
    ...
    private static final Logger LOG = Logger.getLogger(FavoritesActions.class.getName());
    ...
    static Action add () { return Add.getDefault(); }
    public static Action addOnFavoritesNode () { return AddOnFavoritesNode.getDefault(); }
    static Action remove () { return Remove.getDefault(); }
    public static Action select () { return Select.getDefault(); }
    //STARBEANS
    public static Action opendir () { return OpenDirAction.getDefault(); }
    
    //STARBEANS
    private static class OpenDirAction extends AbstractAction {
        
        private static final OpenDirAction OPENDIR = new OpenDirAction ();
    ...
    private static class View extends AbstractAction implements HelpCtx.Provider {
        ...
        public View() {
            putValue(NAME, NbBundle.getMessage(FavoritesActions.class,
                    "ACT_View"));
            Image image = ImageUtilities.loadImage("de/mario/geo/gpxeditor/resources/actionView.gif"); // NOI18N
    ...
    */
    public static class Add extends NodeAction {
        ...
        */
        ...
        //STARBEANS made static and public (org.starbeans.modules.corelite.ui)
    ...
    */
    public static class AddOnFavoritesNode extends Add {
        ...
        */
        ...
        public String getName() {
            return NbBundle.getMessage (
                    FavoritesActions.class, "ACT_AddOnFavoritesNode"); // NOI18N
        }
    }
